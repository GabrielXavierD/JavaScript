      ...
      -Quando colocamos "ordenaNumeros" dentro de sort():
        -> os valores numUm e numDois são recuperados através dele ( sort() ) e são testados
          ...
          (
           ...
           - Se os valores do Array forem numeros, mas em String (Ex.: "12" ) a operação será realizada do mesmo jeito, pois o JS consegue interpretar e fazer o casting (converter tipos de dados em outros tipos de dados);
